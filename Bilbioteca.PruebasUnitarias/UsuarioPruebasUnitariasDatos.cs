...
namespace Bilbioteca.PruebasUnitarias
{
    ...
    public class UsuarioPruebasUnitariasDatos
    {
        ...
        {
            var loUsuario = Alumno.Registrar("2018_00000", "Renzo Condori");
            var loRepositorio = new Repositorio();
            loRepositorio.Adicionar<Alumno>(loUsuario);
        ...
        {
            var loRepositorio = new Repositorio();
            var loUsuario = loRepositorio.ObtenerPorCodigo<Alumno>(1);
        ...
        {
            var loRepositorio = new Repositorio();
            var loUsuario = loRepositorio.Listar<Alumno>().FirstOrDefault(p => p.NombreUsuario == "Renzo Condori");
